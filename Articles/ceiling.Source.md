`Ceiling` is a rounding primitive that reports the closest integer above the given number, rounding the number up. For example, `ceiling 5.2` would report 6, and `ceiling -4.8` would report -4.
